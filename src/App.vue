...
<header>
  <div class="container h-100">
    <div class="d-flex justify-content-between align-items-center h-100">
      <div>
        <img class="py-2" src="./assets/img/dc-logo.png" alt="ImgLogo">
      </div>
...
<!-- #end header whit nav bar -->
<!-- main whit coming soon content -->
<main>
  <section class="app_main d-flex justify-content-between align-items-center">
  <!-- app main whit all content coming soon -->
  <div class="container ">
    <h1>More coming soon</h1>
  </div>
</section>
<section class="blue_container d-flex justify-content-between align-items-center">
  ...
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div>
      <img width="30" src="./assets/img/buy-comics-shop-locator.png" alt="">
...
<!-- #end main whit coming soon content -->
  ...
  <div class="py-5 bg_footer">
      <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
          <h4 class="m-0 me-5 blue_c">FOLLOW US</h4>
